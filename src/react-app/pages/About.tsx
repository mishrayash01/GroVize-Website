...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a192f] via-[#112240] to-[#0a192f]">
        ...
        <div className="max-w-7xl mx-auto text-center">
          <ScrollReveal>
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600">Mission</span>
            </h1>
          </ScrollReveal>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <ScrollReveal>
          <div className="bg-gradient-to-r from-green-500/10 to-green-600/10 backdrop-blur-xl rounded-3xl p-12 border border-green-500/20">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-white mb-2">Yash Mishra</h3>
                <p className="text-green-400 font-semibold mb-4">Founder</p>
                ...
                <div className="flex space-x-3">
                  <a
                    ...
                    aria-label="LinkedIn"
                    className="w-10 h-10 bg-white/5 hover:bg-blue-500/20 rounded-lg flex items-center justify-center text-gray-400 hover:text-blue-400 transition-all duration-300 hover:scale-110"
                  >
                  ...
                  <a
                    ...
                    className="w-10 h-10 bg-white/5 hover:bg-pink-500/20 rounded-lg flex items-center justify-center text-gray-400 hover:text-pink-400 transition-all duration-300 hover:scale-110"
                  >
          ...
          <ScrollReveal>
            <div className="text-center mb-16">
              <h2 className="text-5xl md:text-7xl font-bold text-white mb-6">
                Empowering India's Retail Ecosystem <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600">Without Limits</span>
              </h2>
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
            {[
              ...
              <ScrollReveal key={index} delay={index * 0.2}>
                <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10 hover:bg-white/10 hover:scale-105 transition-all duration-500 group">
